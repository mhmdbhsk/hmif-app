import * as dates from "date-arithmetic"; // Anda perlu menyediakan tipe dari localizer, jika Anda memiliki definisi tipe untuk itu.
...
export function firstVisibleDay(date: Date, localizer: DateLocalizer): Date {
  const firstOfMonth = dates.startOf(date, "month");

  return dates.startOf(firstOfMonth, "week", localizer.startOfWeek());
}

export function lastVisibleDay(date: Date, localizer: DateLocalizer): Date {
  const endOfMonth = dates.endOf(date, "month");

  return dates.endOf(endOfMonth, "week", localizer.startOfWeek());
}

export function visibleDays(date: Date, localizer: DateLocalizer): Date[] {
